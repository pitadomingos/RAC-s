...
export const INITIAL_RAC_DEFINITIONS: RacDef[] = [
    { id: '0', code: 'RAC01', name: 'RAC 01 - Working at Height', validityMonths: 24 },
    { id: '1', code: 'RAC02', name: 'RAC 02 - Vehicles and Mobile Equipment', validityMonths: 24 },
    { id: '2', code: 'RAC03', name: 'RAC 03 - Mobile Equipment Lockout', validityMonths: 24 },
    { id: '3', code: 'RAC04', name: 'RAC 04 - Machine Guarding', validityMonths: 24 },
    { id: '4', code: 'RAC05', name: 'RAC 05 - Confined Space', validityMonths: 24 },
    { id: '5', code: 'RAC06', name: 'RAC 06 - Lifting Operations', validityMonths: 24 },
    { id: '6', code: 'RAC07', name: 'RAC 07 - Ground Stability', validityMonths: 24 },
    { id: '7', code: 'RAC08', name: 'RAC 08 - Electricity', validityMonths: 24 },
    { id: '8', code: 'RAC09', name: 'RAC 09 - Explosives', validityMonths: 12 },
    { id: '9', code: 'RAC10', name: 'RAC 10 - Liquid Metal', validityMonths: 24 },
    { id: '10', code: 'RAC11', name: 'RAC 11 - Mine Traffic & Traffic Rules', validityMonths: 24 },
    { id: '11', code: 'PTS', name: 'PTS - Permissão de Trabalho Seguro', validityMonths: 12 },
    { id: '12', code: 'ART', name: 'ART - Análise de Risco da Tarefa', validityMonths: 12 },
    { id: '13', code: 'LIB_OPS', name: 'LIB-OPS - Liberação Operacional', validityMonths: 12 },
    { id: '14', code: 'LIB_MOV', name: 'LIB-MOV - Liberação de Movimentação', validityMonths: 12 }
];
...
export const MOCK_EMPLOYEES: Employee[] = [
  ...
  { id: 'emp4', name: 'Jose Cossa', recordId: 'VUL-1003', company: 'Vulcan Mining', department: 'Logistics', role: 'Driver', isActive: true, driverLicenseNumber: 'DL-98765', driverLicenseClass: 'Light', driverLicenseExpiry: '2023-01-01', siteId: 's1' }, // Expired DL
  ...
  { id: 'emp9', name: 'Carlos Macuacua', recordId: 'VUL-1007', company: 'Vulcan Mining', department: 'Plant Maintenance', role: 'Engineer', isActive: false, siteId: 's1' }, // Inactive
...
export const MOCK_REQUIREMENTS: EmployeeRequirement[] = [
  ...
  { employeeId: 'emp5', asoExpiryDate: getPastDate(10), requiredRacs: { 'RAC01': true } }, // Expired ASO
  ...
  { employeeId: 'emp10', asoExpiryDate: getFutureDate(5), requiredRacs: { 'RAC01': true, 'RAC03': true } } // ASO Expiring soon
];
