                ...
                {upcomingSessions.map((session) => (
                  <tr key={session.id} className="hover:bg-slate-50 transition-colors">
                    <td className="px-4 py-3 whitespace-nowrap">
                      <div className="text-sm font-medium text-slate-900">{String(session.date)}</div>
                      <div className="text-xs text-gray-500 flex items-center gap-1 mt-1">
                         <Clock size={12} /> {String(session.startTime)}
                      </div>
                    </td>
                    <td className="px-4 py-3">
                      <div className="text-sm font-bold text-slate-700">{String(session.racType)}</div>
                      ...
                      filteredEmployeeBookings.map((item) => (
                        <tr key={item.id} className="hover:bg-slate-50">
                           ...
                           <td className="px-3 py-2 whitespace-nowrap">
                             <div className="text-xs font-bold text-slate-800">{String(item.employee.name)}</div>
                             <div className="text-[10px] text-gray-500 truncate max-w-[120px]" title={item.employee.company}>{String(item.employee.company)}</div>
                           </td>
                           <td className="px-3 py-2 whitespace-nowrap">
