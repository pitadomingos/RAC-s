              ...
              >
                <Popup>
                  <div className="p-1 min-w-[200px]">
                    ...
                    <div className="text-xs text-slate-500 mb-3">{condition.functionLocation}</div>
                    <div className="flex justify-between items-center text-xs font-bold mb-4">
                      <span className="bg-slate-100 text-slate-600 px-2 py-1 rounded">{condition.state}</span>
